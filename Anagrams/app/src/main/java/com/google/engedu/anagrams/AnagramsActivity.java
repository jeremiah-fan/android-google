...
public class AnagramsActivity extends AppCompatActivity {
    ...
    private int numSeconds = DEFAULT_TIME;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        final TextView timerField = (TextView) findViewById(R.id.timer);
        timer = new CountDownTimer(numSeconds * 1000, 1000) {
            public void onTick(long millisUntilFinished) {
                timerField.setText("Seconds Remaining: " + millisUntilFinished / 1000);
            }
            public void onFinish() {
                timerField.setText("You ran out of time!");
                endRound();
            }
        };
        numCorrect = 0;
    ...
    public void endRound(){
        ...
        TextView correctField = (TextView) findViewById(R.id.numcorrect);
        ...
        correctField.setText("SCORE: " + numCorrect);
